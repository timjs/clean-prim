implementation module SystemPrim
...
unimplemented func :== clean_Misc_abort (clean_String_concat "fatal: unimplemented primitive " func)
...
clean_Unsafe_coerce :: .a -> .b
clean_Unsafe_coerce x = code inline {
    pop_a 0
}

clean_Unsafe_force :: !.a -> .a
clean_Unsafe_force x = code inline {
    jsr_eval 0
}
...
clean_Bool_box :: !Bool -> a
clean_Bool_box b = code inline {
    buildB_b 0
    pop_b 1
}

clean_Bool_unbox :: !a -> Bool
clean_Bool_unbox a = code inline {
	repl_r_args 0 1
}
...
clean_Char_box :: !Char -> a
clean_Char_box b = code inline {
    buildC_b 0
    pop_b 1
}

clean_Char_unbox :: !a -> Char
clean_Char_unbox a = code inline {
	repl_r_args 0 1
}
...
clean_Int_box :: !Int -> a
clean_Int_box b = code inline {
    buildI_b 0
    pop_b 1
}

clean_Int_unbox :: !a -> Int
clean_Int_unbox a = code inline {
	repl_r_args 0 1
}
...
clean_Int_upper :: Int
clean_Int_upper = unimplemented "Int.upper"

clean_Int_lower :: Int
clean_Int_lower = unimplemented "Int.lower"
...
clean_Int_min a b = unimplemented "Int.min" /*code inline {
    minI
}*/

clean_Int_max :: !Int !Int -> Int
clean_Int_max a b = unimplemented "Int.max" /*code inline {
    maxI
}*/
...
clean_Int_div a b = unimplemented "Int.div" /*code inline {
    floordivI
}*/

clean_Int_mod :: !Int !Int -> Int
clean_Int_mod a b = unimplemented "Int.mod" /*code inline {
   modI
}*/
...
clean_Int_divMod a b = unimplemented "Int.divMod" /*code inline {
    push_b 1
    push_b 1
    floordivI
    push_b 2
...
clean_Real_box :: !Real -> a
clean_Real_box b = code inline {
    buildR_b 0
    pop_b 1
}

clean_Real_unbox :: !a -> Real
clean_Real_unbox a = code inline {
	repl_r_args 0 1
}
...
clean_String_box :: !String -> a
clean_String_box b = unimplemented "String.box" /*code inline {
    buildAC_b 0
}*/

clean_String_unbox :: !a -> String
clean_String_unbox a = unimplemented "String.box" /*code inline {
	repl_r_args 0 1
}*/
...
clean_Real_toString x = unimplemented "Real.toString" /*code inline {
    .d 0 2 r
        jsr RtoAC
    .o 1 0
}*/
...
clean_String_toInt s = unimplemented "String.toInt"

clean_String_toReal :: !String -> Real
clean_String_toReal s = unimplemented "String.toReal"
