...
/// # Unsafe
///
/// These operations are only for values on the A-stack and change their type!!!

clean_Unsafe_coerce :: .a -> .b
clean_Unsafe_force :: !.a -> .a
// clean_Unsafe_unbox :: !.a -> .b
...
clean_File_absoluteSeek :== 0 /// New position is the seek offset
clean_File_relativeSeek :== 1 /// New position is the current position plus the seek offset
clean_File_fromEndSeek  :== 2 /// New position is the size of the file plus the seek offset
